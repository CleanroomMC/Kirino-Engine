...
//    @Test
//    void transitionTest() {
//        FiniteStateMachine<Integer, Input> FSM = FiniteStateMachine.BuilderImpl.enumIntStateMachine(1, 3, Input.class)
...
//    void validateTest() {
//        assertDoesNotThrow(() -> {
//            FiniteStateMachine.BuilderImpl.enumIntStateMachine(1, 3, Input.class)
//                    .addTransition(1, Input.SECOND, 2)
//                    .addTransition(2, Input.THIRD, 3)
//                    .addTransition(3, Input.FIRST, 1)
//                    .addTransition(2, Input.FIRST, 1)
