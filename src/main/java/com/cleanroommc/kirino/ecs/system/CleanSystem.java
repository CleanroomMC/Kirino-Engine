...
import com.cleanroommc.kirino.ecs.system.exegraph.ISystemExeGraph;
...
public abstract class CleanSystem {
    ...
    /**
     * <p><b><i>Read this part if you utilized {@link ISystemExeGraph} to coordinate the execution.</i></b></p>
     * <br>
     ...
     * <code>execution.noExecutions()</code> will be executed by {@link ISystemExeGraph} before the update by default, which assumes that you didn't start any async task.
     * <p>{@link ISystemExeGraph} relies on {@link ExecutionContainer} to work properly.</p>
     *
     * <br>
     * <hr>
     * <p><b><i>Read this part if you didn't utilize {@link ISystemExeGraph}.</i></b></p>
     * <br>
