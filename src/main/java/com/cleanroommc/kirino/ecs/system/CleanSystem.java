...
/**
 * It's recommended to utilize the implementations of {@link SystemExeFlowGraph} to guide the execution of systems in {@link CleanWorld}.
 *
 * @see CleanWorld
 */
public abstract class CleanSystem {
    ...
    /**
     * <p><b><i>Read this part if you utilized {@link SystemExeFlowGraph} in a {@link CleanWorld} to coordinate the execution of this system:</i></b></p>
     * <br>
     ...
     * called automatically by the {@link SystemExeFlowGraph} before the update.
     * <p>{@link SystemExeFlowGraph} relies on {@link ExecutionContainer} to work properly.</p>
     *
     * <br>
     * <hr>
     * <p><b><i>Read this part if you didn't utilize {@link SystemExeFlowGraph}:</i></b></p>
     * <br>
